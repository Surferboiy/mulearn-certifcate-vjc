document.addEventListener('DOMContentLoaded', () => {
    // --- Configuration ---
    // If hosting frontend separately from backend, change this to your backend URL (e.g. 'https://mulearn-certifcate-vjc.onrender.com')
    // If hosting together, leave it as an empty string ''
    const BACKEND_URL = 'https://mulearn-certifcate-vjc.onrender.com';
